...
as josh for model
survivql model --> failure time is the date of first positive
...
# check to make sure ggplot is doing the scaling correctly --> scale by area of the bubble or by the radius, want it to scale by area
