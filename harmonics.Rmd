...
#plot.cwt(cwt6)
```
reclassify weeks for just once collecting mosquitoes
...
abline(v = dates[313], lty = 6, col = "red")
...
abline(v = datesb[103], lty = 6, col = "red")
abline(v = datesb[125], lty = 6, col = "red")
abline(v = datesb[209], lty = 6, col = "red")
abline(v = datesb[229], lty = 6, col = "red")
abline(v = datesb[887], lty = 6, col = "red")
abline(v = datesb[906], lty = 6, col = "red")
...
#compare to cx. pop
wave6c <- cxp_WNV_harmonics_climate %>% 
...
abline(v = datesc[271], lty = 6, col = "red")
abline(v = datesc[529], lty = 6, col = "red")
abline(v = datesc[536], lty = 6, col = "red")
abline(v = datesc[893], lty = 6, col = "red")
abline(v = datesc[901], lty = 6, col = "red")
...
plot.cwt(cwt5d)
#compare to cx. pop
wave6d <- cxr_WNV_harmonics_climate %>% 
    mutate(x=sqrt(caught_weekly)) %>% 
   dplyr::select(x, t)
...
abline(v = datesd[109], lty = 6, col = "red")
abline(v = datesd[115], lty = 6, col = "red")
abline(v = datesd[739], lty = 6, col = "red")
abline(v = datesd[744], lty = 6, col = "red")
abline(v = datesd[889], lty = 6, col = "red")
abline(v = datesd[902], lty = 6, col = "red")
